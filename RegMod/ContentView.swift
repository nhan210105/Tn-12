    ...
    var body: some View {
        NavigationStack {
            ...
            .fileImporter(isPresented: $showImporter, allowedContentTypes: [.data, .item]) { result in
                toast = result.map { _ in "Shader file selected" }.mapError { $0 }.description
            }
        }
    }
}
        ...
        NavigationStack {
            Form {
                ...
                Section("Version Information") {
                    LabeledContent("App", value: "TnCheats")
                    LabeledContent("Version", value: "2.0.3")
                    LabeledContent("iOS", value: "15.0+")
                }
